package com.example.student.mapappllicationbg;
...
public class MapsActivity extends FragmentActivity implements GoogleMap.OnMapLongClickListener,LocationListener {
    ...
    //LatLng save2 = new LatLng(0,0);
    boolean first_touch = true;

    //user CTRL+I to add method
    @Override
    public void onMapLongClick(LatLng latLng) {

        mMap.addMarker(new MarkerOptions().position(latLng).title("Marker "+ ++tada));
        ...
        {
            mMap.addPolyline(new PolylineOptions().add(save).add(latLng));
        }
    ...
    private void setUpMap() {
        ...
        //Set map zoom level {probably 2 to 10}
    ...
    public void onLocationChanged(Location location) {
        ...
        mMap.addMarker(new MarkerOptions().position(LL).title("Location Changed "+ ++tada2));
    }
